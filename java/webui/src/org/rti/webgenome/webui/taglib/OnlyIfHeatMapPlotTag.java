 ...
 * <code>plotTypeBeanName</code> that is a heat map plot.
 * @author dhall
 *
 */
public class OnlyIfHeatMapPlotTag extends BasePlotTypeSwitch {
	...
	public final int doStartTag() throws JspException {
		...
		if (PlotType.isHeatMapPlot(this.getPlotType())) {
